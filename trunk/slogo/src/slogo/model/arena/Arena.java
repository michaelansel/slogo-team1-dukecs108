...
public class Arena {
	...
	public Arena(ArrayList<Turtle> turtlelist, Map<String, String> variables,
			Map<Integer, String> history, int currturtle, Graphics2D graphics) {
	...
	public Arena clone() {
		return new Arena(myTurtleList, myVariables, myHistory, currTurtle,
				myGraphics);
	}
