...
public class GrammarParseTreeNodeTest extends TestCase {
	...
	public final void testToParserRule() throws ParserException {
		...
		ParseTreeNode someWhitespace = new ParseTreeNode("ExactlyOne",
				"Whitespace");

		ParseTreeNode firstOf = new ParseTreeNode("FirstOf",
				Arrays.asList(new ParseTreeNode[] { exactlyOne1, exactlyOne2 }));
		List<ParseTreeNode> nodes = Arrays.asList(new ParseTreeNode[] {
				exactlyOne1, exactlyOne2, someWhitespace, firstOf });
