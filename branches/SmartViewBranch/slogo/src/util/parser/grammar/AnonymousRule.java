...
public class AnonymousRule
{
    ...
    {
        if (myParameters.size() != params.size()) throw new RuntimeException("Parameter mismatch! Expected: " +
                                                                             myParameters.size() +
                                                                             " Got: " +
                                                                             params.size());
        Map<String, AbstractParserRule> localRules =
            new HashMap<String, AbstractParserRule>(rules);
