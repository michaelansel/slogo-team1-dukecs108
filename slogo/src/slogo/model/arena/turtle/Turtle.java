...
public class Turtle 
{
    ...
    private static Point2D ORIGIN = new Point2D.Double(ArenaDraw.myDimension.getWidth()/2,ArenaDraw.myDimension.getHeight()/2); //TODO this needs to be generated by frame dimensions
